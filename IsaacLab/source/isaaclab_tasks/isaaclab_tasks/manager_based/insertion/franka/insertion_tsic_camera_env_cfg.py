...
from isaaclab.sensors import FrameTransformerCfg, ContactSensorCfg, TiledCameraCfg
...
class InsertionSceneCfg(InteractiveSceneCfg):
    ...
    tiled_camera_1: TiledCameraCfg = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(pos=(1.0, 0.0, 1.2), rot=(0.66446, 0.24184, 0.24184, 0.66446), convention="opengl"),
        data_types=["rgb"],
    ...
    #     offset=TiledCameraCfg.OffsetCfg(pos=(0.55, 0.5, 0.9), rot=(0.0, 0.0, -0.57358, -0.81915), convention="opengl"),
    #     data_types=["rgb"],
    #     spawn=sim_utils.PinholeCameraCfg(
    #         focal_length=24.0, focus_distance=400.0, horizontal_aperture=20.955, clipping_range=(0.1, 20.0)
    #     ),
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        #     func=mdp.save_image,
        #     params={
        #         "sensor_cfg": SceneEntityCfg("tiled_camera_1"),
        #         "data_type": "rgb",
        #         "save_dir": "/home/hyunho_RCI/ai_ws/src/image_feature_compress/data/1",
        #         "folder_name": "all_collected_images"
        #     }
        # )

        image_feature_1 = ObsTerm(
            func=mdp.compressed_image_features,
            params={
                "sensor_cfg": SceneEntityCfg("tiled_camera_1"),
                "data_type": "rgb",
                "convert_perspective_to_orthogonal": False,
                "model_name": "theia-tiny-patch16-224-cddsv",
                "autoencoder_checkpoint_path": "/home/hyunho_RCI/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/insertion/franka/mdp/pretrained_model/vision_auto_encoder/checkpoints/camera1_32/files/checkpoints/best_model.pth",
                "model_device": "cuda:0",
            },
        )

        # image_feature_2 = ObsTerm(
        #     func=mdp.compressed_image_features,
        #     params={
        #         "sensor_cfg": SceneEntityCfg("tiled_camera_2"),
        #         "data_type": "rgb",
        #         "convert_perspective_to_orthogonal": False,
        #         "model_name": "theia-tiny-patch16-224-cddsv",
        #         "autoencoder_checkpoint_path": "/home/hyunho_RCI/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/rci/insertion-v1/franka/mdp/pretrained_model/checkpoints/camera_2/files/checkpoints/best_model.pth",
        #         "model_device": "cuda:0",
        #     },
        # )
...
@configclass
class InsertionCameraEnvCfg(ManagerBasedRLEnvCfg):
