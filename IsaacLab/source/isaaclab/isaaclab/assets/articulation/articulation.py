...
class Articulation(AssetBase):
    ...
    def get_measured_joint_forces(
        ...
        """Get the measured joint forces.

        Args:
            env_ids: The environment indices to get the joint forces for. Defaults to None (all environments).

        Returns:
            The measured joint forces.
        """

        current_joint_forces = self.root_physx_view.get_link_incoming_joint_force()[env_ids]

        return current_joint_forces
