...
from isaaclab.controllers import DifferentialIKControllerCfg, OperationalSpaceControllerCfg, TaskSpaceImpedanceControllerCfg
...
@configclass
class TaskSpaceImpedanceControllerActionCfg(ActionTermCfg):
    """Configuration for the Task Space Impedance Controller."""
    ...
    class_type: type[ActionTerm] = task_space_actions.TaskSpaceImpedanceAction

    joint_names: list[str] = MISSING
    """List of joint names or regex expressions that the action will be mapped to."""
    body_name: str = MISSING
    """Name of the body or frame for which controller is performed."""
    body_offset: OffsetCfg | None = None
    """Offset of target frame w.r.t. to the body frame. Defaults to None, in which case no offset is applied."""
    
    clip_action: bool = False
    """Whether to clip the action to the joint limits. Defaults to True."""
    
    ema_factor: float = 0.2
    """The weight for the moving average. Defaults to 0.2.
    If set to 1.0, the processed action is applied directly without any moving average window.
    """
    ...
    controller: TaskSpaceImpedanceControllerCfg = MISSING
    """The configuration for the differential TaskSpaceImpedance controller."""